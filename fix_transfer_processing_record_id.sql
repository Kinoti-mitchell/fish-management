-- Fix Transfer Function to Handle processing_record_id Constraint
...
-- Create approve_transfer function that handles processing_record_id constraint
...
-- Success message
SELECT 'Transfer approval functions created successfully with processing_record_id constraint fix!' as status;
