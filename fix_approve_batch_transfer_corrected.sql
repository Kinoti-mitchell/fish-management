-- Fix Missing approve_batch_transfer Function with Correct Parameter Order
...
-- Create approve_transfer function with correct parameter order: (p_transfer_id, p_approved_by)
...
BEGIN
    ...
    ELSE
        ...
        -- First, create a dummy sorting batch for transfers
    ...
    -- Update storage capacities (if function exists)
    BEGIN
...
-- Create approve_batch_transfer function with correct parameter order: (p_transfer_id, p_approved_by)
...
-- Create decline_transfer function with correct parameter order: (p_transfer_id, p_approved_by)
...
-- Success message
SELECT 'Transfer approval functions created successfully with correct parameter order!' as status;
