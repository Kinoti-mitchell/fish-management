-- Fix Processing Yield Constraint Issue
...
-- Create approve_transfer function that handles processing_yield constraint
...
BEGIN
    ...
    IF FOUND THEN
        ...
        AND size_class = v_transfer.size_class;
    ELSE
        -- Create a dummy processing record with ALL required fields (including processing_yield)
        INSERT INTO processing_records (
            ...
            processing_waste,
            processing_yield,  -- This was missing!
            ...
            0.00,  -- processing_yield (was NULL, now 0.00)
...
-- Success message
SELECT 'Transfer functions fixed - processing_yield constraint resolved!' as status;
