...
export function Navigation({ currentSection, onNavigate, onLogout }: NavigationProps) {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <div className="hidden md:flex md:w-72 bg-card border-r flex-col fixed left-0 top-0 h-screen z-50 overflow-x-hidden">
        <div className="p-6 border-b bg-gradient-to-r from-slate-50 to-gray-50 flex-shrink-0">
        ...
        <div className="p-3 flex-1 flex flex-col overflow-hidden overflow-x-hidden bg-gradient-to-b from-blue-50 to-blue-100">
          {loading ? (
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 bg-card border-b">
        <div className="flex items-center justify-between p-3">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="left" className="w-72 p-0 overflow-x-hidden">
              ...
              <div className="p-3 h-[calc(100vh-100px)] overflow-hidden bg-gradient-to-b from-blue-50 to-blue-100">
                <NavContent />
              </div>
            </SheetContent>
          </Sheet>
