-- Minimal Fix for Sorting Module Errors
-- This script only fixes the essential issues without trying to sync users
...
-- 7. Insert a dummy user for testing (you can replace this with real user data later)
