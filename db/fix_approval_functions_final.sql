-- FINAL Fix for Transfer Approval Functions
-- This version handles the sorting_batch_id constraint properly
...
-- Create approve_transfer function that properly handles sorting_batch_id constraint
...
-- Success message
SELECT 'FINAL Transfer approval functions created successfully!' as status;