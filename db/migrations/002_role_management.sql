...
-- Policy: Admins can view all profiles (using user_metadata to avoid recursion)
...
-- Policy: Admins can update all profiles (using user_metadata to avoid recursion)
...
-- Policy: Admins can insert profiles (using user_metadata to avoid recursion)
...
-- Policy: Admins can manage all roles (using user_metadata to avoid recursion)
...
-- Policy: Admins can view all sessions (using user_metadata to avoid recursion)
...
-- Policy: Only admins can manage system config (using user_metadata to avoid recursion)
