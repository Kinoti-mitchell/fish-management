-- IMMEDIATE FIX for Ambiguous Column Reference Error
-- Run this in Supabase SQL Editor to fix the get_inventory_with_fifo_ordering function
...
-- Test the function
SELECT 'Fixed ambiguous column reference error!' as status;
