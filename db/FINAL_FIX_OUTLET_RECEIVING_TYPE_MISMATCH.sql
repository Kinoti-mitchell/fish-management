-- FINAL FIX: Outlet Receiving Type Mismatch
-- This script fixes the type mismatch error in get_outlet_receiving_records function
...
-- Step 2: Create the corrected function with proper types that match the actual table schema
...
RETURNS TABLE (
    ...
    expected_value DECIMAL(12,2),  -- FIXED: Changed from DECIMAL(10,2) to DECIMAL(12,2) to match table
    actual_value_received DECIMAL(12,2),  -- FIXED: Changed from DECIMAL(10,2) to DECIMAL(12,2) to match table
