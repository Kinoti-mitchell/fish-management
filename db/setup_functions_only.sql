-- Setup Inventory Functions Only
-- This script creates only the necessary functions without modifying storage locations
...
-- Step 2: Create the main FIFO inventory function
...
-- Step 3: Create FIFO order fulfillment function
...
-- Step 4: Create inventory reduction function for order approval
...
-- Step 6: Run initial capacity update
...
-- Step 9: Final status
SELECT 
    'Inventory functions setup completed successfully!' as status,
