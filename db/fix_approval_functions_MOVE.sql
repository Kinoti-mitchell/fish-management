-- MOVE Fix for Transfer Approval Functions
-- This version simply moves existing inventory records by changing storage_location_id
...
-- Create approve_transfer function that moves existing inventory records
...
BEGIN
    ...
    IF v_updated_rows = 0 THEN
        ...
        RETURN QUERY SELECT FALSE, 'No inventory found in source storage to transfer'::TEXT;
        RETURN;
    END IF;
...
-- Success message
SELECT 'MOVE Transfer approval functions created successfully!' as status;
