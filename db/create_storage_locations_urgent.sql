-- URGENT: Create Storage Locations Table
-- This will fix the 404 error for storage_locations table
-- Run this in Supabase SQL Editor immediately

-- Drop the table if it exists (to start fresh)
DROP TABLE IF EXISTS storage_locations CASCADE;

-- Create storage_locations table with proper schema
...
SELECT name, location_type, capacity_kg, status FROM storage_locations ORDER BY name;
