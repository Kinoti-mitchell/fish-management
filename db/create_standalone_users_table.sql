...
-- This creates a simple users table that works without Supabase Auth

-- Drop existing profiles table if it exists and has foreign key constraints
DROP TABLE IF EXISTS profiles CASCADE;

-- Create a standalone users table
