-- Fix the ambiguous column reference error in add_stock_from_sorting RPC
-- The error occurs because multiple tables have 'id' columns and PostgreSQL can't determine which one to use
