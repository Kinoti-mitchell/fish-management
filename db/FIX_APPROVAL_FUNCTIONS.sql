-- Fix Transfer Approval Functions
-- This script ensures the approve_transfer and decline_transfer functions are properly defined
...
BEGIN
    ...
    DO UPDATE SET
        ...
        total_weight_grams = sorting_results.total_weight_grams + (v_transfer.weight_kg * 1000)::INTEGER,
        updated_at = NOW();
