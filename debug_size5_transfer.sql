-- DEBUG SIZE 5 TRANSFER DATA
-- This will help us understand why size 5 isn't showing transfer information

SELECT '=== SIZE 5 DETAILED DATA ===' as section;

-- Get detailed information for size 5 in storage 1
SELECT 
    sr.id,
    sr.size_class,
    sr.total_pieces,
...
-- Check if there are any transfers that moved size 5 to storage 1
SELECT '=== TRANSFERS FOR SIZE 5 TO STORAGE 1 ===' as section;
SELECT 
    t.id,
    t.from_storage_name,
    t.to_storage_name,
...
SELECT '=== COMPLETED TRANSFERS FOR SIZE 5 ===' as section;
SELECT 
    t.id,
    t.from_storage_name,
    t.to_storage_name,
